...
def gen_frames():
    ...
    camera = cv2.VideoCapture('rtsp://192.168.183.137:60554/live')
...
def view():
    ...
    if status == True:
        print('flag!')
        return render_template('view.html', flag='HACKTIZEN{15_y4m@ngc1ty_re411_5@fe?}')
    else:
        print('not flag!')
        return render_template('view.html', flag='HACKTIZEN{fake_flag}')
